...
chemical_eqns = [
    #-κ[1]*x[1]+κ[2]*x[2], 
    κ[1]*x[1] - (κ[2]+κ[26])*x[2]+κ[27]*x[3]-κ[3]*x[2]*x[4]+(κ[4]+κ[5])*x[14],
    κ[26]*x[2]-κ[27]*x[3]-κ[14]*x[3]*x[6]+(κ[15]+κ[16])*x[15],
    -κ[3]*x[2]*x[4]-κ[9]*x[4]*x[10]+κ[4]*x[14]+κ[8]*x[16]+(κ[10]+κ[11])*x[18],
    -κ[28]*x[5]+κ[29]*x[7]-κ[6]*x[5]*x[8]+κ[5]*x[14]+κ[7]*x[16],
    -κ[14]*x[3]*x[6]-κ[20]*x[6]*x[11]+κ[15]*x[15]+κ[19]*x[17]+(κ[21]+κ[22])*x[19],
    ...
    -κ[23]*x[11]+κ[30]*x[10]-κ[31]*x[11]-κ[20]*x[6]*x[11]-κ[24]*x[11]*x[12]+κ[25]*x[13]+κ[21]*x[19], 
...
F = System(chemical_eqns, variables = [κ; c; x])
