...
u = rand(ComplexF64, myk)
v = rand(ComplexF64, myk)
PWS = PseudoWitnessSet(F_ordered, create_line(u, v, size(F_ordered, 2))) # issue! Our linear space intersects at something larger than points.
